  ...
  return (
    <>
      ...
      <div className="relative flex w-full flex-col items-center justify-center">
        ...
        <div className="relative flex w-full items-center justify-center pt-[60px] sm:pt-[110px] xl:pt-[198px] 2xl:pt-[198px]">
          <div className="animated-gradient-shadow relative mx-auto flex w-full max-w-[90%] items-center justify-center px-[8px] py-[4px] sm:max-w-[77%] xl:px-[14px] xl:py-[7px]">
            ...
            <div className="absolute top-0 z-[-1] h-[250px] w-full bg-custom-gradient blur-[6px] sm:z-[-1] md:h-[600px] md:blur-[15px] xl:blur-[16px] 2xl:h-[578px] 2xl:blur-[16px]"></div>
