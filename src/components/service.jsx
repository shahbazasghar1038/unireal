  ...
  return (
    <div className="grid w-full gap-3 px-4 pb-[40px] pt-[20px] sm:pb-[60px] sm:pt-[60px] md:grid-cols-2 lg:pb-[80px] lg:pt-[95px]">
      <div className="group relative aspect-[939/684] w-full overflow-hidden rounded-[15px] lg:rounded-[31px]">
        <div className="absolute left-0 top-0 flex h-full w-full flex-col items-center justify-end gap-[20px] bg-grid-custom-gradient pb-[20px] opacity-0 transition-all group-hover:opacity-[1] sm:pb-[30px] 2xl:gap-[22px] 2xl:pb-[40px]">
          <h2 className="max-w-[500px] px-4 text-center text-[20px] font-[700] leading-[1.4] md:px-0 lg:text-[30px] xl:text-[30px] 2xl:max-w-[600px] 2xl:text-[35px]">
