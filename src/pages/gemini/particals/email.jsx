  ...
  return (
    <div className="flex flex-col items-center justify-center gap-[40px] bg-section-gradient px-5 py-[70px] md:py-[95px] 2xl:gap-[50px] 2xl:py-[105px]">
      ...
      <form
        ...
        className="relative flex h-[60px] w-full max-w-[716px] items-center justify-center overflow-hidden rounded-lg bg-[white] md:h-[70px] 2xl:h-[86px]"
      >
        <input
          type="text"
          value={email}
        ...
        <button
          type="submit"
          disabled={loading}
          className="absolute right-[10px] h-[46px] rounded-lg bg-black px-5 text-[20px] font-[500] text-white transition-all hover:opacity-80 md:h-[50px] md:px-[45px] md:text-[24px] 2xl:right-[15px] 2xl:h-[60px]"
        >
